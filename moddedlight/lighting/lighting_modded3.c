...
class LightingNew
{
  ...
  class C_Day4
  {
	...
	ambientCloud[] = {{0.2,0.23,0.45}, 9.2};
  ...
  class C_Day8
  {
	...
	ambientCloud[] = {{0.12,0.18,0.28}, 12.2};
  ...
  class C_Day12
  {
	...
	ambientCloud[] = {{0.12,0.18,0.28}, 12.6};
  ...
  class C_Day16
  {
	...
	ambientCloud[] = {{0.12,0.18,0.24}, 12.4};
  ...
  class C_Day35
  {
	...
	ambientCloud[] = {{0.12,0.18,0.24}, 13.0};
  ...
  class C_Day60
  {
	...
	ambientCloud[] = {{0.12,0.18,0.24}, 13.8};
