modded class LoadingScreen {
	...
	void LoadingScreen(DayZGame game) {
		...
		m_ImageBackground.LoadImageFile(0, "NK/Tweaks/loadingscreen/data/nkloadingscreen_co.paa");
...
modded class LoginQueueBase {
	...
	override Widget Init() {
		...
		imageWidgetBackground.LoadImageFile(0, "NK/Tweaks/loadingscreen/data/nkloadingscreen_co.paa");
		return w;
	}
}
